    ...
    <div class="container mt-3">
        ...
        <form action="/add-kontrak/{{ $kos }}" method="post">
            ...
            <div>
                ...
                <input type="date" class="form-control @error('tgl_mulai') is-invalid @enderror" name="tgl_mulai"
                    id="tgl_mulai" value="{{ old('tgl_mulai') }}" />
                <!-- notif error -->
                @error('tgl_mulai')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div>
                ...
                <input type="date" class="form-control @error('tgl_selesai') is-invalid @enderror" name="tgl_selesai"
